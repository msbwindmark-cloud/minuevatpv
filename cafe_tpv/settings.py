"""
Django settings for cafe_tpv project.
...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '127.0.0.1,localhost,minuevatpv.pythonanywhere.com').split(',')
...
WSGI_APPLICATION = 'cafe_tpv.wsgi.application'
